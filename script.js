...
// CAROUSEL NAVIGATION - FIXED FOR MOBILE WITH SWIPE SUPPORT
...
if (carouselContainer && carouselPrev && carouselNext) {
    ...
    function getScrollAmount() {
        ...
        if (isMobile) {
            // On mobile, get the actual carousel item width
            ...
            return carouselContainer.clientWidth + 16;
        } else {
            // On desktop, scroll by one item width + gap (280 + 24)
            return 304;
        }
    }
    ...
    function handleSwipe() {
        const swipeThreshold = 50; // Minimum distance to trigger scroll
